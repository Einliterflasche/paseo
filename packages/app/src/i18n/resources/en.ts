export const en = {
  services: {
    managed: {
      ...
      unavailable: "Preview settings are unavailable on this connection.",
      alreadyEnabled: "Preview is already enabled. Check its current settings.",
      invalidInput: "Choose an upstream path mode.",
      enableHelp: "Configure your app to use the preview base path after enabling it.",
      disableHelp: "Disabling ends preview access and leaves the service running.",
    },
    registration: {
      basePath: "Preview base path",
      ...
      hostOnly: "Host only",
      mount: "Upstream path",
      preservePath: "Keep service prefix",
      stripPath: "Remove service prefix",
      external: "Registered service",
      enabled: "Preview enabled",
      disabled: "Preview disabled",
      connect: "Enable preview",
      remove: "Remove registration",
      unavailable: "Service registration is unavailable on this connection.",
      restarting:
        "Preview setup is paused during host restart or recovery. Resolve any reported recovery error before trying again when the host is ready.",
      unknownRegistration: "This registration is no longer available.",
      unknownWorkspace: "This workspace is no longer available.",
      duplicate: "That port is already registered.",
      infrastructurePort: "This port is reserved for Paseo.",
      invalidInput: "Enter a name and a port from 1 to 65535.",
      storageError: "The service registration could not be saved. Check host storage.",
      unknownResult: "The result is unknown. Check the catalog before trying again.",
    },
    openBrowserTab: "Open in new tab",
    openBrowserTabReady: "Open in new tab",
    closeBrowserPreview: "Close browser preview",
    previewCloseError: "Could not confirm closing the preview. Access may still be active.",
    openPreview: "Open preview",
    reloadPreview: "Reload preview",
    recoverPreview: "Reset preview session",
    previewEnded: "The connection changed. Open the preview again to reconnect.",
    previewError:
      "The preview could not be opened. Check the service and connection, then try again.",
    previewReady: "Open this service in a workspace tab.",
    preferenceLoadError:
      "Could not load the saved view. Retry loading it or choose a different view.",
    preferenceSaveError: "Could not save the view. Choose it again to retry.",
    refreshError: "Could not refresh services. Use Refresh to try again.",
    catalogUnavailable: "This host does not support the service catalog. Update Paseo on the host.",
    stale: "Showing last known state. Service controls are unavailable until refresh succeeds.",
    refresh: "Refresh",
    title: "Services",
    description: "Workspace services on this host.",
    grid: "Grid",
    list: "List",
    search: "Search services",
    clearSearch: "Clear search",
    offline: "Host disconnected. Showing last known state; actions are unavailable.",
    ...
    start: "Start",
    logs: "Logs",
    readOnly: "This host does not support service controls.",
    changed: "The service or connection changed. Check its current state before trying again.",
    actionError:
      "Could not confirm the action. Check the current service state before trying again.",
  },
  common: {
    hostRecovery: {
