...
export const ja: TranslationResources = {
  services: {
    managed: {
      settings: "プレビュー設定",
      disable: "プレビューを無効にする",
      unavailable: "この接続ではプレビュー設定を利用できません。",
      alreadyEnabled: "プレビューは既に有効です。現在の設定を確認してください。",
      invalidInput: "サーバーに渡すパスの形式を選択してください。",
      enableHelp: "有効にした後、アプリがプレビューのベースパスを使用するように設定してください。",
      disableHelp: "無効にするとプレビューへのアクセスが終了します。サービスは実行を継続します。",
    },
    registration: {
      basePath: "プレビューのベースパス",
      title: "サービスを登録",
      register: "登録",
      name: "名前",
      localPort: "ローカルポート",
      ...
      hostOnly: "ホストのみ",
      mount: "転送先のパス",
      preservePath: "サービスのプレフィックスを維持",
      stripPath: "サービスのプレフィックスを削除",
      external: "登録済みサービス",
      enabled: "プレビュー有効",
      disabled: "プレビュー無効",
      connect: "プレビューを有効化",
      remove: "登録を解除",
      unavailable: "この接続ではサービスを登録できません。",
      restarting:
        "ホストの再起動または復旧中はプレビューの設定が一時停止されます。表示された復旧エラーを解決し、ホストの準備ができてから再試行してください。",
      unknownRegistration: "この登録は利用できなくなりました。",
      unknownWorkspace: "このワークスペースは利用できなくなりました。",
      duplicate: "そのポートは登録済みです。",
      infrastructurePort: "このポートはPaseo用に予約されています。",
      invalidInput: "名前と1〜65535のポートを入力してください。",
    ...
    recoverPreview: "プレビューのセッションをリセット",
    previewEnded: "接続が変更されました。プレビューを開き直して再接続してください。",
    previewError: "プレビューを開けませんでした。サービスと接続を確認して、再試行してください。",
    previewReady: "ワークスペースのタブでこのサービスを開きます。",
    preferenceLoadError:
      "保存した表示設定を読み込めませんでした。再試行するか、別の表示を選択してください。",
    preferenceSaveError: "表示設定を保存できませんでした。もう一度選択して再試行してください。",
    refreshError: "サービスを更新できませんでした。「更新」で再試行してください。",
    catalogUnavailable:
      "このホストはサービス一覧に対応していません。ホストの Paseo を更新してください。",
    stale: "最後に確認した状態です。更新が成功するまでサービスの操作はできません。",
    refresh: "更新",
    title: "サービス",
    description: "このホスト上のワークスペースのサービス。",
    grid: "グリッド",
    list: "リスト",
    search: "サービスを検索",
    clearSearch: "検索をクリア",
    offline: "ホストが切断されています。最後に確認した状態を表示しています。操作はできません。",
    ...
    start: "起動",
    logs: "ログ",
    readOnly: "このホストはサービス操作に対応していません。",
    changed: "サービスまたは接続が変更されました。再試行の前に現在の状態を確認してください。",
    actionError: "操作を確認できませんでした。再試行の前にサービスの現在の状態を確認してください。",
  },
  common: {
    hostRecovery: {
