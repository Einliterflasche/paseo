...
export const ptBR: TranslationResources = {
  services: {
    managed: {
      settings: "Configurações da prévia",
      disable: "Desativar prévia",
      unavailable: "As configurações da prévia estão indisponíveis nesta conexão.",
      alreadyEnabled: "A prévia já está ativada. Confira as configurações atuais.",
      invalidInput: "Escolha um modo de caminho do servidor.",
      enableHelp: "Configure o aplicativo para usar o caminho base da prévia após ativá-la.",
      disableHelp: "Desativar encerra o acesso à prévia e mantém o serviço em execução.",
    },
    registration: {
      basePath: "Caminho base da prévia",
      title: "Registrar serviço",
      register: "Registrar",
      name: "Nome",
      localPort: "Porta local",
      workspace: "Espaço de trabalho",
      hostOnly: "Somente host",
      mount: "Caminho do servidor",
      preservePath: "Manter prefixo do serviço",
      stripPath: "Remover prefixo do serviço",
      external: "Serviço registrado",
      enabled: "Prévia ativada",
      disabled: "Prévia desativada",
      connect: "Ativar prévia",
      remove: "Remover registro",
      unavailable: "O registro de serviços está indisponível nesta conexão.",
      restarting:
        "A configuração das prévias está pausada durante a reinicialização ou recuperação do host. Resolva qualquer erro de recuperação informado e tente novamente quando o host estiver pronto.",
      unknownRegistration: "Este registro não está mais disponível.",
      unknownWorkspace: "Este espaço de trabalho não está mais disponível.",
      duplicate: "Essa porta já está registrada.",
      infrastructurePort: "Esta porta está reservada para o Paseo.",
      invalidInput: "Informe um nome e uma porta entre 1 e 65535.",
    ...
    reloadPreview: "Recarregar prévia",
    recoverPreview: "Redefinir sessão da prévia",
    previewEnded: "A conexão mudou. Abra a prévia novamente para reconectar.",
    previewError:
      "Não foi possível abrir a prévia. Verifique o serviço e a conexão e tente novamente.",
    previewReady: "Abra este serviço em uma aba do espaço de trabalho.",
    preferenceLoadError:
      "Não foi possível carregar a visualização salva. Tente novamente ou escolha outra visualização.",
    preferenceSaveError:
      "Não foi possível salvar a visualização. Escolha-a novamente para tentar de novo.",
    refreshError: "Não foi possível atualizar os serviços. Use Atualizar para tentar novamente.",
    catalogUnavailable: "Este host não suporta o catálogo de serviços. Atualize o Paseo no host.",
    stale:
      "Exibindo o último estado conhecido. Os controles estarão disponíveis após uma atualização bem-sucedida.",
    refresh: "Atualizar",
    title: "Serviços",
    description: "Serviços dos espaços de trabalho neste host.",
    grid: "Grade",
    list: "Lista",
    search: "Buscar serviços",
    clearSearch: "Limpar busca",
    offline: "Host desconectado. Exibindo o último estado conhecido; ações indisponíveis.",
    ...
    port: "Porta {{port}}",
    cached: "Último estado conhecido",
    reachable: "Acessível",
    unreachable: "Inacessível",
    unknown: "Estado de saúde desconhecido",
    stop: "Parar",
    start: "Iniciar",
    logs: "Logs",
    readOnly: "Este host não oferece controles de serviços.",
    changed: "O serviço ou a conexão mudou. Confira o estado atual antes de tentar novamente.",
    actionError:
      "Não foi possível confirmar a ação. Confira o estado atual do serviço antes de tentar novamente.",
  },
  common: {
    hostRecovery: {
