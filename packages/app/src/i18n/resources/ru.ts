...
export const ru: TranslationResources = {
  services: {
    managed: {
      settings: "Настройки предпросмотра",
      disable: "Отключить предпросмотр",
      unavailable: "Настройки предпросмотра недоступны для этого подключения.",
      alreadyEnabled: "Предпросмотр уже включён. Проверьте текущие настройки.",
      invalidInput: "Выберите режим пути сервера.",
      enableHelp:
        "После включения настройте приложение на использование базового пути предпросмотра.",
      disableHelp: "Отключение закрывает доступ к предпросмотру, но не останавливает сервис.",
    },
    registration: {
      basePath: "Базовый путь предпросмотра",
      ...
      mount: "Путь к приложению",
      preservePath: "Сохранять префикс сервиса",
      stripPath: "Удалять префикс сервиса",
      external: "Зарегистрированный сервис",
      enabled: "Предпросмотр включён",
      disabled: "Предпросмотр выключен",
      connect: "Включить предпросмотр",
      remove: "Удалить регистрацию",
      unavailable: "Регистрация сервисов недоступна через это соединение.",
      restarting:
        "Настройка предпросмотра приостановлена на время перезапуска или восстановления хоста. Устраните указанную ошибку восстановления, если она есть, и повторите попытку, когда хост будет готов.",
      unknownRegistration: "Эта регистрация больше недоступна.",
      unknownWorkspace: "Это рабочее пространство больше недоступно.",
      duplicate: "Этот порт уже зарегистрирован.",
      infrastructurePort: "Этот порт зарезервирован для Paseo.",
      invalidInput: "Введите имя и порт от 1 до 65535.",
    ...
    recoverPreview: "Сбросить сеанс предпросмотра",
    previewEnded: "Соединение изменилось. Откройте предпросмотр снова для подключения.",
    previewError:
      "Не удалось открыть предпросмотр. Проверьте сервис и соединение и повторите попытку.",
    previewReady: "Откройте сервис во вкладке рабочего пространства.",
    preferenceLoadError:
      "Не удалось загрузить сохранённый вид. Повторите загрузку или выберите другой вид.",
    preferenceSaveError: "Не удалось сохранить вид. Выберите его ещё раз, чтобы повторить попытку.",
    refreshError: "Не удалось обновить службы. Нажмите «Обновить», чтобы повторить.",
    catalogUnavailable: "Этот хост не поддерживает каталог служб. Обновите Paseo на хосте.",
    stale:
      "Показано последнее известное состояние. Управление станет доступно после успешного обновления.",
    refresh: "Обновить",
    title: "Сервисы",
    description: "Сервисы рабочих пространств на этом хосте.",
    grid: "Плитки",
    list: "Список",
    search: "Поиск сервисов",
    clearSearch: "Очистить поиск",
    offline: "Хост отключён. Показано последнее известное состояние; действия недоступны.",
    ...
    port: "Порт {{port}}",
    cached: "Последнее известное состояние",
    reachable: "Доступен",
    ...
    start: "Запустить",
    logs: "Журналы",
    readOnly: "Этот хост не поддерживает управление сервисами.",
    changed:
      "Сервис или соединение изменились. Проверьте текущее состояние перед повторной попыткой.",
    actionError:
      "Не удалось подтвердить действие. Проверьте текущее состояние сервиса перед повторной попыткой.",
  },
  common: {
    hostRecovery: {
      ...
      stoppingTitle: "Восстановление останавливает работу на {{hostName}}",
      stoppingDescription:
        "Восстановление завершилось ошибкой. Paseo останавливает затронутых агентов и сохраняет их результаты. Приостановка работы ещё не подтверждена.",
      blockedTitle: "Восстановление на {{hostName}} требует вмешательства",
      blockedDescription:
        "Paseo не смог подтвердить остановку всех затронутых агентов. Новая работа и перезапуск заблокированы. Оператор хоста должен устранить ошибку перед повторной попыткой восстановления.",
      affectedAgents: "Затронутые агенты: {{agents}}",
    },
    back: "Назад",
    loading: "Загрузка...",
    actions: {
