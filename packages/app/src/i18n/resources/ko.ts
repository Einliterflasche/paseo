...
export const ko: TranslationResources = {
  services: {
    managed: {
      settings: "미리보기 설정",
      disable: "미리보기 비활성화",
      unavailable: "이 연결에서는 미리보기 설정을 사용할 수 없습니다.",
      alreadyEnabled: "미리보기가 이미 활성화되어 있습니다. 현재 설정을 확인하세요.",
      invalidInput: "서버 경로 모드를 선택하세요.",
      enableHelp: "활성화 후 앱에서 미리보기 기본 경로를 사용하도록 설정하세요.",
      disableHelp: "비활성화하면 미리보기 접근이 종료되며 서비스는 계속 실행됩니다.",
    },
    registration: {
      basePath: "미리보기 기본 경로",
      title: "서비스 등록",
      ...
      hostOnly: "호스트만",
      mount: "업스트림 경로",
      preservePath: "서비스 접두사 유지",
      stripPath: "서비스 접두사 제거",
      external: "등록된 서비스",
      enabled: "미리보기 활성화됨",
      disabled: "미리보기 비활성화됨",
      connect: "미리보기 활성화",
      remove: "등록 제거",
      unavailable: "이 연결에서는 서비스를 등록할 수 없습니다.",
      restarting:
        "호스트를 다시 시작하거나 복구하는 동안 미리보기 설정이 일시 중지됩니다. 표시된 복구 오류를 해결한 뒤 호스트가 준비되면 다시 시도하세요.",
      unknownRegistration: "이 등록은 더 이상 사용할 수 없습니다.",
      unknownWorkspace: "이 워크스페이스는 더 이상 사용할 수 없습니다.",
      duplicate: "이미 등록된 포트입니다.",
      infrastructurePort: "이 포트는 Paseo용으로 예약되어 있습니다.",
      invalidInput: "이름과 1~65535 사이의 포트를 입력하세요.",
      storageError: "서비스 등록을 저장할 수 없습니다. 호스트 저장소를 확인하세요.",
      unknownResult: "결과를 확인할 수 없습니다. 다시 시도하기 전에 카탈로그를 확인하세요.",
    },
    openBrowserTab: "새 탭에서 열기",
    openBrowserTabReady: "새 탭에서 열기",
    closeBrowserPreview: "브라우저 미리보기 닫기",
    previewCloseError: "미리보기 닫기를 확인하지 못했습니다. 접근 권한이 아직 유효할 수 있습니다.",
    openPreview: "미리 보기 열기",
    reloadPreview: "미리 보기 새로 고침",
    recoverPreview: "미리 보기 세션 초기화",
    previewEnded: "연결이 변경되었습니다. 미리 보기를 다시 열어 연결하세요.",
    previewError: "미리 보기를 열 수 없습니다. 서비스와 연결을 확인한 후 다시 시도하세요.",
    previewReady: "작업 공간 탭에서 이 서비스를 엽니다.",
    preferenceLoadError:
      "저장된 보기 설정을 불러오지 못했습니다. 다시 시도하거나 다른 보기를 선택하세요.",
    preferenceSaveError: "보기 설정을 저장하지 못했습니다. 다시 선택하여 재시도하세요.",
    refreshError: "서비스를 새로 고칠 수 없습니다. 새로 고침을 눌러 다시 시도하세요.",
    catalogUnavailable:
      "이 호스트는 서비스 목록을 지원하지 않습니다. 호스트의 Paseo를 업데이트하세요.",
    stale: "마지막으로 확인된 상태입니다. 새로 고침이 성공할 때까지 서비스를 제어할 수 없습니다.",
    refresh: "새로고침",
    title: "서비스",
    description: "이 호스트의 작업 공간 서비스입니다.",
    grid: "그리드",
    list: "목록",
    search: "서비스 검색",
    clearSearch: "검색 지우기",
    offline: "호스트 연결이 끊어졌습니다. 마지막 상태를 표시하며 작업을 사용할 수 없습니다.",
    ...
    start: "시작",
    logs: "로그",
    readOnly: "이 호스트는 서비스 제어를 지원하지 않습니다.",
    changed: "서비스 또는 연결이 변경되었습니다. 다시 시도하기 전에 현재 상태를 확인하세요.",
    actionError: "작업을 확인할 수 없습니다. 다시 시도하기 전에 서비스의 현재 상태를 확인하세요.",
  },
  common: {
    hostRecovery: {
