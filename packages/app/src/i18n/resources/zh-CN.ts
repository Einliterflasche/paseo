...
export const zhCN: TranslationResources = {
  services: {
    managed: {
      settings: "预览设置",
      disable: "禁用预览",
      unavailable: "此连接无法使用预览设置。",
      alreadyEnabled: "预览已启用。请检查当前设置。",
      invalidInput: "请选择上游路径模式。",
      enableHelp: "启用后，请配置应用以使用预览基础路径。",
      disableHelp: "禁用将结束预览访问，服务仍会继续运行。",
    },
    registration: {
      basePath: "预览基础路径",
      title: "注册服务",
      ...
      connect: "启用预览",
      remove: "移除注册",
      unavailable: "当前连接无法注册服务。",
      restarting:
        "主机重启或恢复期间，预览设置已暂停。请先解决已报告的恢复错误，待主机就绪后重试。",
      unknownRegistration: "此注册已不可用。",
      unknownWorkspace: "此工作区已不可用。",
      duplicate: "该端口已注册。",
      infrastructurePort: "此端口为 Paseo 保留。",
      invalidInput: "请输入名称和 1 至 65535 之间的端口。",
      storageError: "无法保存服务注册，请检查主机存储。",
      unknownResult: "结果未知，请先检查目录再重试。",
    },
    openBrowserTab: "在新标签页中打开",
    openBrowserTabReady: "在新标签页中打开",
    closeBrowserPreview: "关闭浏览器预览",
    previewCloseError: "无法确认预览已关闭。访问权限可能仍然有效。",
    openPreview: "打开预览",
    reloadPreview: "重新加载预览",
    recoverPreview: "重置预览会话",
    previewEnded: "连接已更改。请重新打开预览以连接。",
    previewError: "无法打开预览。请检查服务和连接，然后重试。",
    previewReady: "在工作区标签页中打开此服务。",
    preferenceLoadError: "无法加载已保存的视图。请重试或选择其他视图。",
    preferenceSaveError: "无法保存视图。请再次选择以重试。",
    refreshError: "无法刷新服务。请点击“刷新”重试。",
    catalogUnavailable: "此主机不支持服务目录。请更新主机上的 Paseo。",
    stale: "正在显示上次已知状态。刷新成功后才能控制服务。",
    refresh: "刷新",
    title: "服务",
    description: "此主机上的工作区服务。",
    grid: "网格",
    list: "列表",
    search: "搜索服务",
    clearSearch: "清除搜索",
    offline: "主机已断开连接。显示最后已知状态，操作不可用。",
    noMatches: "没有匹配的服务。",
    ...
    logs: "日志",
    readOnly: "此主机不支持服务控制。",
    changed: "服务或连接已更改。请在重试前检查当前状态。",
    actionError: "无法确认操作。请在重试前检查服务的当前状态。",
  },
  common: {
    hostRecovery: {
