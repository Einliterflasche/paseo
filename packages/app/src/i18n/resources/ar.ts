...
export const ar: TranslationResources = {
  services: {
    managed: {
      settings: "إعدادات المعاينة",
      disable: "تعطيل المعاينة",
      unavailable: "إعدادات المعاينة غير متاحة عبر هذا الاتصال.",
      alreadyEnabled: "المعاينة مفعّلة بالفعل. تحقّق من إعداداتها الحالية.",
      invalidInput: "اختر وضع مسار الخادم.",
      enableHelp: "اضبط تطبيقك لاستخدام المسار الأساسي للمعاينة بعد تفعيلها.",
      disableHelp: "يُنهي التعطيل الوصول إلى المعاينة مع إبقاء الخدمة قيد التشغيل.",
    },
    registration: {
      basePath: "المسار الأساسي للمعاينة",
      title: "تسجيل خدمة",
      register: "تسجيل",
      name: "الاسم",
      ...
      hostOnly: "المضيف فقط",
      mount: "مسار الخادم",
      preservePath: "الإبقاء على بادئة الخدمة",
      stripPath: "إزالة بادئة الخدمة",
      external: "خدمة مسجلة",
      enabled: "المعاينة مفعّلة",
      disabled: "المعاينة معطّلة",
      connect: "تفعيل المعاينة",
      remove: "إزالة التسجيل",
      unavailable: "تسجيل الخدمات غير متاح عبر هذا الاتصال.",
      restarting:
        "إعداد المعاينات متوقف مؤقتًا أثناء إعادة تشغيل المضيف أو استعادته. عالج أي خطأ استعادة مُبلّغ عنه، ثم حاول مجددًا عندما يكون المضيف جاهزًا.",
      unknownRegistration: "لم يعد هذا التسجيل متاحًا.",
      unknownWorkspace: "لم تعد مساحة العمل هذه متاحة.",
      duplicate: "هذا المنفذ مسجل بالفعل.",
      infrastructurePort: "هذا المنفذ محجوز لـ Paseo.",
      invalidInput: "أدخل اسمًا ومنفذًا بين 1 و65535.",
      storageError: "تعذر حفظ تسجيل الخدمة. تحقق من مساحة تخزين المضيف.",
      unknownResult: "النتيجة غير معروفة. تحقق من الدليل قبل المحاولة مجددًا.",
    },
    openBrowserTab: "فتح في علامة تبويب جديدة",
    openBrowserTabReady: "فتح في علامة تبويب جديدة",
    closeBrowserPreview: "إغلاق معاينة المتصفح",
    previewCloseError: "تعذر تأكيد إغلاق المعاينة. قد يظل الوصول نشطًا.",
    openPreview: "فتح المعاينة",
    reloadPreview: "إعادة تحميل المعاينة",
    recoverPreview: "إعادة تعيين جلسة المعاينة",
    previewEnded: "تغيّر الاتصال. افتح المعاينة مجددًا لإعادة الاتصال.",
    previewError: "تعذّر فتح المعاينة. تحقّق من الخدمة والاتصال ثم حاول مجددًا.",
    previewReady: "افتح هذه الخدمة في علامة تبويب مساحة العمل.",
    preferenceLoadError: "تعذر تحميل العرض المحفوظ. أعد المحاولة أو اختر عرضًا مختلفًا.",
    preferenceSaveError: "تعذر حفظ العرض. اختره مرة أخرى لإعادة المحاولة.",
    refreshError: "تعذر تحديث الخدمات. اضغط على تحديث للمحاولة مجددًا.",
    catalogUnavailable: "هذا المضيف لا يدعم قائمة الخدمات. حدّث Paseo على المضيف.",
    stale: "تُعرض آخر حالة معروفة. لن تتاح أدوات التحكم حتى ينجح التحديث.",
    refresh: "تحديث",
    title: "الخدمات",
    description: "خدمات مساحات العمل على هذا المضيف.",
    grid: "شبكة",
    list: "قائمة",
    search: "البحث في الخدمات",
    clearSearch: "مسح البحث",
    offline: "المضيف غير متصل. تُعرض آخر حالة معروفة؛ الإجراءات غير متاحة.",
    ...
    start: "بدء",
    logs: "السجلات",
    readOnly: "هذا المضيف لا يدعم التحكم بالخدمات.",
    changed: "تغيرت الخدمة أو الاتصال. تحقق من الحالة الحالية قبل المحاولة مجددًا.",
    actionError: "تعذر تأكيد الإجراء. تحقق من الحالة الحالية للخدمة قبل المحاولة مجددًا.",
  },
  common: {
    hostRecovery: {
      ...
      stoppingTitle: "الاستعادة توقف العمل على {{hostName}}",
      stoppingDescription:
        "فشلت الاستعادة. يعمل Paseo على إيقاف الوكلاء المتأثرين وحفظ مخرجاتهم. لم يُؤكَّد بعد توقف العمل مؤقتًا.",
      blockedTitle: "الاستعادة تحتاج إلى تدخل على {{hostName}}",
      blockedDescription:
        "تعذّر على Paseo التأكد من توقف جميع الوكلاء المتأثرين. تم حظر العمل الجديد وإعادة التشغيل. يجب على مشغّل المضيف حل الخطأ قبل إعادة محاولة الاستعادة.",
      affectedAgents: "الوكلاء المتأثرون: {{agents}}",
    },
    back: "خلف",
    loading: "تحميل...",
    actions: {
